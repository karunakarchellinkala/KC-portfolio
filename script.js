...
// EmailJS Setup
(function(){
  emailjs.init("9BkVIXZAFsqwJTxT2"); // Public Key
})();
const contactForm = document.getElementById('contactForm');
contactForm.addEventListener('submit', function(e) {
  e.preventDefault();
  emailjs.sendForm("service_c47adqo", "template_9m7fp5v", this)
    .then(() => {
...
// Parallax effect for hero section removed to prevent merging with about section
...
📧 Contact: karunakarchellinkala@email.com
`);
